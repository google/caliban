...
def create_parser():
  ...
  parser = argparse_flags.ArgumentParser(
    ...
    description="""Configurable arguments for the UV Metrics demo.""",
    prog="python -m trainer.train",
  )

  parser.add_argument(
    "--gcloud_path",
    help="""Path for gcloud logs; if supplied, used for persisting logs. This must be of
  ...
  parser.add_argument(
    "--local_path",
    help="""Path for gcloud logs; if supplied, this location on the local filesystem is
  ...
  parser.add_argument(
    "--tensorboard_path",
    help="""project-local path for tensorboard logs; if supplied, this location on the
...
https://www.tensorflow.org/api_docs/python/tf/keras/activations""",
  ...
  parser.add_argument(
    "--width", type=int, default=1000, help="Width of the network to train."
  )
  parser.add_argument(
    "--depth", type=int, default=2, help="Depth of the network to train."
  )
  parser.add_argument(
    "--learning_rate",
    "--lr",
